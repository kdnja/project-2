 ...
 * 
 * V1.0 6/1/2019 Copyright(c) 2019 PLTW to present. All rights reserved
 */
...
public class DataCollector {
    ...
    /**
     * Gather the data contained in the files socialMediaPostsFilename and targetWordsFilename
     * (including punctuation), with words separated by a single space
     * 
    ...
    /**
     * Get the next post in socialMediaPosts with words separated by a single space, or "NONE" if
    ...
    /**
     * Get the next line in targetWords, with words separated by a space, or "NONE" if there is no
     * more data.
     * 
